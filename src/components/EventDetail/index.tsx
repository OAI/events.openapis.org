...
import { hasPhoto, photoSrc } from '@/lib/avatarPlaceholder';
        ...
        {agendaCategories.length > 0 && (
          ...
          <section className="relative z-10 mx-auto mb-12 mt-20 max-w-[1408px] md:mt-[140px] md:px-6">
            ...
            {agendaDates.length > 1 && (
              <div className="mb-10 ml-6 inline-flex items-center rounded-[20px] bg-[rgba(21,25,28,0.08)] p-0 md:mb-20 md:ml-20 [[data-theme=dark]_&]:bg-[#1f2326]">
                      ...
                      const sessionContent = (
                        <div className="flex flex-col gap-6">
                          ...
                          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between md:gap-8">
                            ...
                            <h4 className="m-0 font-onest text-[24px] font-bold leading-[1.2] tracking-oai text-[#15191c] md:max-w-[800px] md:text-[32px] [[data-theme=dark]_&]:text-white">
                              {session.title}
                            </h4>
                            {session.time && (
        ...
        {sponsors.length > 0 && (
          <section className="relative isolate flex h-[300px] items-center justify-center md:h-[765px]">
            ...
            <svg
              ...
              className="pointer-events-none absolute left-1/2 top-1/2 block h-auto w-full min-w-[1280px] max-w-[1728px] -translate-x-1/2 -translate-y-[59.3%] select-none"
            >
          ...
          (() => {
            ...
            const sessionSpeakers: AgendaSpeaker[] =
              selectedSession.speakers && selectedSession.speakers.length > 0
                ...
                : selectedSession.speaker
                  ...
                  : [];
            // Neither link -> no button row at all, rather than an empty one
            // still carrying its padding.
            const hasSessionLinks = !!(selectedSession.slidesUrl || selectedSession.videoUrl);
            ...
            return (
              ...
              >
                ...
                <button
                  onClick={closeSession}
                  className="absolute right-6 top-6 z-10 hidden h-9 w-9 cursor-pointer items-center justify-center rounded-full border-none bg-[#15191c] text-white transition-colors hover:bg-[#15191c]/80 md:flex [[data-theme=dark]_&]:bg-white [[data-theme=dark]_&]:text-[#15191c] [[data-theme=dark]_&]:hover:bg-white/80"
                  aria-label="Close"
                >
                  <svg
                    width="22"
                ...
                <div className="my-0 flex min-h-0 w-full max-w-[1360px] flex-1 flex-col items-stretch gap-3 md:my-0 md:mt-20 md:items-center">
                  ...
                  <div
                    ...
                    className="flex min-h-0 w-full flex-1 flex-col overflow-hidden rounded-[40px] bg-white px-6 pb-8 pt-6 md:max-h-[1000px] md:px-20 md:py-12 [[data-theme=dark]_&]:bg-[#1e2225]"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <div className="mx-auto flex min-h-0 w-full max-w-[800px] flex-1 flex-col gap-6">
                      ...
                      <div className="flex flex-shrink-0 flex-col gap-6 md:gap-12">
                        {selectedSession.time && (
                          <div className="flex max-w-[240px] items-center gap-6 py-0 md:py-2">
                            <div className="h-[10px] w-[5px] flex-shrink-0 rounded-[10px] bg-brand-green" />
                            <span className="font-onest text-base font-normal leading-[1.2] tracking-oai text-[#15191c] md:text-lg [[data-theme=dark]_&]:text-white">
                              {startTime}
                            </span>
                            <div className="h-px flex-1 bg-[rgba(21,25,28,0.12)] [[data-theme=dark]_&]:bg-[rgba(255,255,255,0.16)]" />
                            <span className="font-onest text-base font-normal leading-[1.2] tracking-oai text-[#15191c] md:text-lg [[data-theme=dark]_&]:text-white">
                        ...
                        <h2 className="m-0 font-onest text-[32px] font-bold leading-[1.1] tracking-oai text-[#15191c] md:text-[48px] md:tracking-[-1.92px] [[data-theme=dark]_&]:text-white">
                      ...
                      <div className="min-h-0 flex-1 overflow-y-auto">
                        <p className="m-0 whitespace-pre-line font-onest text-base font-normal leading-[1.4] tracking-oai text-[#15191c] md:text-lg [[data-theme=dark]_&]:text-white">
